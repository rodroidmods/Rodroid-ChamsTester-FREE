...
jobjectArray GetFeatureList(JNIEnv *env, jobject context) {
    ...
    const char *features[] = {
            OBFUSCATE("Category__Chams Mods"),
            OBFUSCATE("20__Toggle__True__Shader Capture Mode"),
            OBFUSCATE("21__Buttons__Show Shaders,Clear Shaders"),
            OBFUSCATE("22__Button__Pick Shader"),
            OBFUSCATE("1__InputText__Custom Shader"),
            OBFUSCATE("Category__Chams Feature"),
            OBFUSCATE("2__ArrayBox__Default,Shading,Wireframe,Glow,Outline,Heat"),
            OBFUSCATE("8__Toggle__Rainbow Chams"),
		    OBFUSCATE("9__Toggle__Auto Rainbow"),
		    OBFUSCATE("10__SeekBar__Line Width__1__10"),
		    OBFUSCATE("11__ColorPicker__Chams Color__255__255__0__0"),

            OBFUSCATE("SettingsAdd__Category__Settings"),
            OBFUSCATE("-10__SettingsAdd__InputText__Target Library"),
            OBFUSCATE("-11__SettingsAdd__RichTextView__Library Status: <i>checking...</i>"),
            OBFUSCATE("-1__SettingsAdd__Toggle__Save feature preferences"),
            OBFUSCATE("-3__SettingsAdd__Toggle__Auto size vertically"),
            OBFUSCATE("-4__SettingsAdd__SeekBar__Icon Opacity__0__10"),
            OBFUSCATE("-5__SettingsAdd__SeekBar__Icon Size__0__100"),
            OBFUSCATE("-6__SettingsAdd__Button__Hide Menu"),
            OBFUSCATE("-7__SettingsAdd__Button__Kill Menu"),
            OBFUSCATE("SettingsAdd__Category__True__Connected with me"),
            OBFUSCATE("SettingsAdd__ButtonLink__Telegram__https://t.me/+WmudnO0-xoNhMDQ8"),
            OBFUSCATE("SettingsAdd__ButtonLink__Report Bugs__https://t.me/+QylrYL1GNsJiYjc0"),
    };

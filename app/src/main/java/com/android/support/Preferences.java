...
public class Preferences {
    ...
    public static native void Changes(Context con, int fNum, String fName, int i, int i2, int i3, int i4, boolean bool, String str);
    ...
    public static void changeFeatureInt(String featureName, int featureNum, int value) {
        ...
        Changes(context, featureNum, featureName, value, 0, 0, 0, false, null);
    }
    ...
    public static void changeFeatureString(String featureName, int featureNum, String str) {
        ...
        Changes(context, featureNum, featureName, 0, 0 ,0 ,0, false, str);
    }
    ...
    public static void changeFeatureBool(String featureName, int featureNum, boolean bool) {
        ...
        Changes(context, featureNum, featureName, 0, 0, 0, 0, bool, null);
    }
	
	public static void ChangeFeatureColor(String str, int i, int i2, int i3, int i4, int i5){
        with(context).writeInt(i, i2);
        Changes(context, i, str, i, i2, i3, i4, false ,null);
    }

    public static int loadPrefInt(String featureName, int featureNum) {
        if (loadPref) {
            int i = Preferences.with(context).readInt(featureNum);
            Changes(context, featureNum, featureName, i, 0, 0, 0, false, null);
            return i;
        }
        return 0;
    }
    ...
    public static boolean loadPrefBool(String featureName, int featureNum, boolean bDef) {
        ...
        Changes(context, featureNum, featureName, 0, 0, 0, 0, bDef, null);
        return bDef;
    }
